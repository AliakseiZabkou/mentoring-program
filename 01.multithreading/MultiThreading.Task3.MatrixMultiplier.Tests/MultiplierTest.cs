...
namespace MultiThreading.Task3.MatrixMultiplier.Tests
{
    ...
    public class MultiplierTest
    {
        ...
        [TestMethod]
        public void ParallelEfficiency100On100Test()
        {
            ...
            IMatrix resultMatrix = new MatricesMultiplier().Multiply(m1, m2);

            stopWatch.Stop();

            TimeSpan regularTime = stopWatch.Elapsed;

            stopWatch.Restart();

            IMatrix resultMatrixParallel = new MatricesMultiplierParallel().Multiply(m1, m2);
